...
class PushHookTriggerHandlerImplTest {
    ...
    @BeforeEach
    void setUp() {
        pushHookTriggerHandler = new PushHookTriggerHandlerImpl(false, false);
    }
    ...
    void push_ciSkip() throws Exception {
        ...
        pushHookTriggerHandler.handle(
                ...
                PullRequestLabelFilterFactory.newPullRequestLabelFilter(null));
        ...
        pushHookTriggerHandler.handle(
                ...
                pushHook() 
                        ...
                        .withProject(project()
                                .withName("test-name")
                                .withId(1)
                                .withUrl("https://gitee.org/test")
                                .withSshUrl("https://gitee.org/test")
                                .withNamespace("test-namespace")
                                .withWebUrl("https://gitee.org/test")
                                .withGitHttpUrl("https://gitee.org/test")
                                .build())
